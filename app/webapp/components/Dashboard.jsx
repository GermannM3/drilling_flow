    	    ...
    	    <header className="flex flex-col sm:flex-row justify-between items-center mb-8 gap-4">
    	      ...
    	      <div className="flex items-center gap-4">
    	        <details className="relative">
    	          <summary className="flex items-center gap-2 cursor-pointer hover:bg-emerald-800 p-2 rounded-lg transition-all">
    	            <span className="material-symbols-outlined text-emerald-400">notifications</span>
    	            <span className="absolute -top-1 -right-1 bg-red-500 text-white text-xs rounded-full h-5 w-5 flex items-center justify-center">3</span>
    	          </summary>
    	          <div className="absolute right-0 mt-2 w-64 bg-slate-800 rounded-lg shadow-2xl p-4 z-10 border-2 border-emerald-500">
    	            <div className="flex flex-col gap-2">
    	              <div className="p-2 hover:bg-slate-700 rounded-lg transition-all text-emerald-400">
    	                <p className="font-semibold">Новый Заказ #1234</p>
    	                <p className="text-sm text-emerald-300">Запрос на бурение скважины - 5км</p>
    	              </div>
    	            </div>
    	          </div>
    	        </details>
    	        <details className="relative">
    	          <summary className="flex items-center gap-2 cursor-pointer hover:bg-emerald-800 p-2 rounded-lg transition-all text-emerald-400">
